...
function setup() {
  ...
  var trafficUrl =
    "https://tm.amap.com/trafficengine/mapabc/traffictile?v=1.0&;t=1&z={z}&y={y}&x={x}&t={time}";
  ...
  var Roads = // en, zh_en
    add(
      "Gaode Roads [zh]",
      new GaodeLayer({ style: 7, maxNativeZoom: 20, lang: "zh_cn" })
    );
  ...
  add(
    "Gaode Roads + Traffic",
    L.layerGroup([Roads, new AmapTraffic({ opacity: 0.75 })])
  );

  var Satellite = add(
    "Gaode Satellite",
    new GaodeLayer({ style: 6, type: "satellite" })
  );
